                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        autoComplete="email"
                        required
                        className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-yellow-500 sm:text-sm sm:leading-6"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm leading-6">
                      <a href="#" className="font-semibold text-yellow-500 hover:text-yellow-400" onClick={openDialog}>
                        Forgot password?
                      </a>
                    </div>
                  </div>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="flex w-full justify-center rounded-md bg-amber-400 px-3 py-1.5 text-sm font-semibold leading-6 text-zinc-900 shadow-sm hover:bg-amber-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600"
                    >
                      Sign in
                    </button>
                    {/* <LoginButton /> */}
...
function LoginButton() {
  ...
  return (
    <button className="flex w-full justify-center rounded-md bg-amber-400 px-3 py-1.5 text-sm font-semibold leading-6 text-zinc-900 shadow-sm hover:bg-amber-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600" aria-disabled={pending} type="submit" onClick={handleClick}>
      Login
    </button>
  )
}
